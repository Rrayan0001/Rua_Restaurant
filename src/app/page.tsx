...
export default function Home() {
  return <>
    ...
    <main id="main">
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-content wrap">
          <div className="eyebrow hero-eyebrow"><span className="little-star">✳</span> A LITTLE ESCAPE IN YELAHANKA</div>
          ...
          <div className="hero-actions"><BookingButton className="button button-peach">Find your table <ArrowUpRight size={18} /></BookingButton><a className="hero-menu-link" href="#flavours">A taste of Rua <span>↗</span></a></div>
        </div>
        ...
        <a className="round-stamp" href="#story" aria-label="Discover the Rua feeling"><svg viewBox="0 0 120 120" aria-hidden="true"><defs><path id="stamp-circle" d="M60,60m-44,0a44,44 0 1,1 88,0a44,44 0 1,1 -88,0" /></defs><text><textPath href="#stamp-circle" textLength="273">COME HUNGRY · LEAVE HAPPY · </textPath></text></svg><span>✳</span></a>
      </section>
      ...
      <section className="interlude" aria-label="Slow down and savour"><Image src="/images/evening.jpg" alt="A softly lit restaurant at evening — illustrative atmosphere" fill sizes="100vw" /><div className="interlude-shade" /><Reveal className="interlude-copy"><span className="eyebrow">PUT THE WORLD ON PAUSE</span><h2>No rush.<br />Just <em>one more bite.</em></h2><span className="interlude-star" aria-hidden="true">✳</span></Reveal><span className="interlude-caption">A MOOD WORTH MAKING TIME FOR</span></section>

      <section id="moments" className="moments section-light section-space"><div className="wrap"><Reveal className="section-heading"><div><p className="eyebrow"><span className="line" /> LITTLE MOMENTS, WELL SPENT</p><h2>Your people.<br /><em>Your kind of place.</em></h2></div><p>A long lunch. A catch-up that was overdue.<br />Or a celebration of absolutely nothing.<br />There’s always a reason to gather.</p></Reveal><Gallery /><div className="moments-bottom"><span>GOOD FOOD IS A REASON. GOOD COMPANY IS THE OCCASION.</span><span className="tiny-flower" aria-hidden="true">✳</span></div></div></section>
    ...
    <MobileActions />
    <footer className="footer"><div className="wrap"><div className="footer-top"><a className="brand" href="#" aria-label="Rua home">rua<span>YELAHANKA</span></a><p>Come hungry.<br /><em>Leave a little happier.</em></p><a className="back-top" href="#">BACK TO TOP <ArrowUpRight size={18} /></a></div><div className="footer-links"><span>GOOD FOOD. GREAT COMPANY.</span><nav aria-label="Footer navigation"><a href="#story">Our story</a><a href={restaurant.menuUrl} target="_blank" rel="noreferrer">The menu ↗</a><a href="#visit">Find us</a></nav></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Rua, Yelahanka</span><span>Made for moments that matter.</span><a href="/credits">Sources & image credits</a></div></div></footer>
  </>;
}
