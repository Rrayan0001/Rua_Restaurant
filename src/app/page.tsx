...
import { RuaDoodle } from "@/components/rua-doodle";
...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section id="visit" className="visit section-space"><div className="wrap visit-grid"><Reveal className="visit-copy"><p className="eyebrow"><span className="line" /> WE’LL SAVE YOU A SEAT</p><h2>Let’s make<br />a little <em>time.</em></h2><p>Your next good memory could start<br />with a table at Rua.</p><BookingButton className="button button-peach">Plan your visit <ArrowUpRight size={18} /></BookingButton><span className="booking-note">Table reservations via Zomato</span></Reveal><Reveal className="visit-card"><RuaDoodle className="visit-doodle" /><span className="eyebrow">FIND YOUR WAY TO RUA</span><h3>A little closer<br />to a good time.</h3><div className="visit-details"><div><MapPin size={18} /><p>Yelahanka, Bengaluru<span>Karnataka, India</span></p></div><div><Clock3 size={18} /><p>Every day, {restaurant.hours}<span>Listed hours · confirm when booking</span></p></div></div><a className="text-link" href={restaurant.directionsUrl} target="_blank" rel="noreferrer">Get directions <MoveUpRight size={19} /></a><span className="card-coordinates">13.1751° N &nbsp; / &nbsp; 77.5480° E</span></Reveal></div></section>
    </main>
    <MobileActions />
